...
public class HomeAdminView extends AbstractView {
    ...
    public void showOptions() {
        ...
        System.out.println("[U]tenti [I]mpiegati [A]rticoli [T]racciamento [E]sci");
    ...
    public void submit() {    
        ...
        switch (choice) {
        case "i":
        	this.request.put("mode", "EMPLOYEELIST");
        ...
        case "t":
        	this.request.put("mode", "ITEMLENTLIST");
        	this.request.put("choice", 3);
